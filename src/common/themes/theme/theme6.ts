...
const Theme6 = (colors: PalettesProps, mode: ThemeMode): PaletteThemeProps => {
  ...
  let ownerColors = ['#3e7d8b', '#5ab4c7', '#D4A59A', '#846790', '#a881af', '#F76C6C', '#F54242'];
  ...
  return {
    ...
    owner: {
      lighter: ownerColors[0],
      light: ownerColors[1],
      main: ownerColors[2],
      dark: ownerColors[3],
      darker: ownerColors[4],
      navigation: ownerColors[5],
      navigationLight: ownerColors[6],
      contrastText
    },
    grey: greyColors
  };
